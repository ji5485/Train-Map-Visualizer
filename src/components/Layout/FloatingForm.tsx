...
import TrainPlatformForm from '../AppendTrainPlatform/TrainPlatformForm'
import DrawingLineForm from '../SelectDrawingLine/DrawingLineForm'
import ModifyTrainPlatformForm from '../ModifyTrainPlatform/ModifyTrainPlatformForm'
import ModifyTrainLineForm from '../ModifyTrainLine/ModifyTrainLineForm'
import SettingMenuContent from '../SettingMenu/SettingMenuContent'
import FindTrainPathContent from '../FindTrainPath/FindTrainPathContent'
import ManageTrainLineItemForm from '../ManageTrainLineItem/ManageTrainLineItemForm'
